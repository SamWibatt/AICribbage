...
class CutForDealMode(Mode):
    def setup(self):
        ...
        newrailext.bottom = SLIDEREXT_CUTDL_BOTTOM_MARGIN
        ...
        # make two cards, invisible bc no card has been cut
        newupcards = []
        for j in range(2):
        ...
        self.add_sprite_list("upcards",None,newupcards)

# TODO ****************************************************************************************************************
# TODO ****************************************************************************************************************
# TODO ****************************************************************************************************************
# HEREAFTER THE SAME AS CUTSTARTERMODE
# TODO ****************************************************************************************************************
# TODO ****************************************************************************************************************
# TODO ****************************************************************************************************************
